...
show_kcptun_for_ss_ssr(){
    ...
    if [ "${kcptun_install_flag}" == "true" ]; then
        ...
        echo -e "Kcptun sndwnd             : ${COLOR_GREEN}2048${COLOR_END}"
        echo -e "Kcptun rcvwnd             : ${COLOR_GREEN}2048${COLOR_END}"
        ...
        echo -e "KCP parameter : ${COLOR_GREEN}--crypt ${set_kcptun_method} --key  --mtu ${set_kcptun_mtu} --sndwnd 128 --rcvwnd 1024 --mode ${set_kcptun_mode}${show_kcptun_nocomp}${COLOR_END}"
        echo "----------------------------------------------------------"
